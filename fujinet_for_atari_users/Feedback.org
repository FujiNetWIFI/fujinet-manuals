Feedback from users
1. It might be worth mentioning that the Fujinet plugs into the SIO port and is compatible with (nearly?) all Atari computers.
2. "TNFS" is mentioned, but not described, on page 1. It may be worth explaining what TNFS is.
...
5. In Figure I-3, the arrows between each item should be double-ended, since the Fujinet supports sending as well as receiving data over the WWW.
...
7. For Apetime, it might be worthwhile giving a mention to SpartaDOS X, and any Atari OSes besides SpartaDOS X that can make use of it.
